...
export default function Navbar() {
  ...
  <div className="container-fluid">
    <Link className="navbar-brand fs-1 fst-italic" to={"/"}>FoodFood</Link>
    ...
    <div className="collapse navbar-collapse" id="navbarNav">
     ...
     :""
      ...
      <div className='d-flex '>
          ...
          <Link className="btn bg-primary text-white mx-1 " style={{boxShadow:"2px black"}} to={"/createuser"}>Signup</Link>
        </div>
        :<div>
